...
foreach my $project (@projects) {
    ...
    # Generate dashboard html page for project.
    ...
    print "    - Compressing rule-checking metrics file [${project}${project_id}_pmd.xml] to [${dir_out_projects}${project_id}_pmd.zip].\n";
    my $cmd = "cd $project && zip -r ../../scripts/publish/${dir_out_projects}${project_id}_pmd.zip ${project_id}_pmd.xml";
    @cmd_out = `$cmd`;
    print "    - Compressing rule-checking metrics file [${project}${project_id}_findbugs.xml] to [${dir_out_projects}${project_id}_findbugs.zip].\n";
